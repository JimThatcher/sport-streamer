...
namespace DakAccess
{
    ...
    public class DakSoccer : ISportData
    {
        ...
        public string GetData(ref string data) {
            _dataUpdated = false;
            _data = data;
            return JsonSerializer.Serialize(new SoccerData(this));
        }
