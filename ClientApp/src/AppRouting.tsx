...
import ScoreCanvas from './project/ScoreCanvas';
import ScoreCanvasMulti from './project/ScoreCanvasMulti';
  ...
  return (
    <Authentication>
      ...
      <Routes>
        <Route
          path="/scorebug"
          element={<RequireAuthenticated> <ScoreCanvas /> </RequireAuthenticated>}
        />
        <Route
          path="/scorebughd"
          element={<RequireAuthenticated> <ScoreCanvasMulti /> </RequireAuthenticated>}
        />
        <Route
          path="/unauthorized"
